...
export default function CommentSection({ postId }) {
	...
	// Editar comentário && atualizar comentários
			...
			{currentUser && (
				<form onSubmit={handleSubmit} className='border border-orange-600 rounded-md p-3'>
					...
					<div className='flex justify-between items-center mt-5'>
						...
						<Button outline className='bg-gradient-to-r from-orange-500 to-red-600' type='submit'>
							Comentar
						</Button>
					</div>
					{commentError && (
			...
			<Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
				...
				<Modal.Body>
					<div className='text-center'>
						...
						<h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Tem a certeza que deseja eliminar este comentário?</h3>
					</div>
