...
export default function DashUsers() {
	...
	// Botão para mostrar mais utilizadores
				...
				<>
					<Table hoverable className='shadow-md'>
						<Table.Head>
							...
							<Table.HeadCell>Imagem do utilizador</Table.HeadCell>
							<Table.HeadCell>Nome do utilizador</Table.HeadCell>
						...
						{users.map(user => (
							<Table.Body className='divide-y' key={user._id}>
								<Table.Row className='bg-white dark: border-gray-700 dark:bg-gray-800 '>
									...
									<Table.Cell align='center' className='items-center'>
			...
			<Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
				...
				<Modal.Body>
					<div className='text-center'>
						...
						<h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Tem a certeza que deseja eliminar este utilizador?</h3>
					</div>
